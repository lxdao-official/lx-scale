    ...
    <div className="flex justify-center items-center min-h-screen p-4">
      <div className="max-w-4xl w-full bg-white rounded-lg shadow-lg p-8 border">
        <h1 className="text-2xl font-bold mb-6">
          {questionnaire.title} - {T({ en: 'Test', zh: '测评' })}
        </h1>

        <div className="mb-8">
          <p className="text-gray-700 mb-4">
            {lang === 'en'
              ? `This is the assessment page for ${questionnaire.title}. Select the option that best matches your situation for each question.`
          ...
          <div className="bg-yellow-50 border-l-4 border-yellow-400 p-4 mb-6">
            <p className="text-sm text-yellow-700">
              {T({
                en: `Note: This page is just an example. The actual assessment content needs to be designed based on the specific questions of ${questionnaire.title}.`,
                zh: `注意：此页面仅为示例。实际测评内容需要根据${questionnaire.title}
              的具体问题设计。`,
              })}
            </p>
          </div>
          ...
          <div className="space-y-8 mt-8">
            <div className="border rounded-lg p-4">
              <h3 className="font-medium mb-4">
                问题1：这是{questionnaire.title}的示例问题
              </h3>
            ...
            <div className="border rounded-lg p-4">
              <h3 className="font-medium mb-4">
                问题2：这是{questionnaire.title}的另一个示例问题
              </h3>
              <div className="space-y-2">
                <div className="flex items-center">
        ...
        <div className="flex justify-between mt-8">
          ...
          <Button>{T({ en: 'Next', zh: '下一页' })}</Button>
        </div>
      </div>
    </div>
  );
