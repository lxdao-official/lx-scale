    ...
    return (
        <>
            <button
                ...
                title={showProgressPanel ? "隐藏题目导航" : "显示题目导航"}
            >
                <svg
            ...
            <div className={`fixed right-4 top-20 w-64 bg-white rounded-lg shadow-lg p-4 transition-transform duration-300 transform ${showProgressPanel ? 'translate-x-0' : 'translate-x-full'}`}>
                <div className="mb-4">
                    <div className="text-sm font-medium mb-2">完成进度：{Math.round(completionPercentage)}%</div>
